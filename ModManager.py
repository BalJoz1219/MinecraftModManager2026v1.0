...
t.write("Delete mod")
t.penup()
def launchMinecraft_click(x,y):
    if 500 <= x <= 600 and 270 <= y <= 300:
        os.startfile("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\TLauncher\\TLauncher.lnk")
